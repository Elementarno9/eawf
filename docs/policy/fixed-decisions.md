...
- Quant and ML ship as catalog stubs in v0.1; in v0.2 the audit-check DSL skeleton landed (P13 W04, B019) but the profile bodies (B006/B007) remain on the v0.4 backlog.
- Catalog stubs `re`, `game`, `apps`, `infra`, `docs`, `robotics` ship with no body in v0.1.
