...
- W05 ship: 3 new auto-memory entries under `<home>/.claude/projects/...` (out-of-repo) — `feedback_no_design_comments_in_source.md`, `feedback_eu_calibration.md`, `project_v03_v05_spec_series.md`; `MEMORY.md` index extended with 3 new lines [6].
