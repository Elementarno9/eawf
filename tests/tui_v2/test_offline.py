"""Tests for the ``tui_v2`` non-interactive text renderers.

Covers the two deterministic surfaces in :mod:`eawf.tui_v2.offline`:
...
from eawf.tui_v2.offline import build_status_text, emit_status, offline_render
