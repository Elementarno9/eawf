...
:class:`~eawf.tui_v2.screens.overlays.detail.DetailModal` through the App's
...
from eawf.tui_v2.palette.verbs import _handle_find, rank_find_hits
from eawf.tui_v2.screens.overlays.detail import DetailModal
...
def test_handle_find_routes_through_modal_cap(tmp_path: Path) -> None:
    ...
    async def body() -> None:
        from eawf.tui_v2.app import EaApp
        from eawf.tui_v2.screens.overlays.metrics import MetricsModal
