...
from eawf.tui_v2.palette.verbs import _handle_audit, _handle_roadmap
from eawf.tui_v2.screens.overlays.audit_running import AuditRunningModal
from eawf.tui_v2.screens.overlays.plan_preview import PlanPreviewModal
...
def test_audit_verb_routes_through_push_modal_cap() -> None:
    async def body() -> None:
        from eawf.tui_v2.screens.overlays.audit_running import AuditProgress
