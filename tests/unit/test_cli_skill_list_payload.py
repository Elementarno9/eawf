...
pins the per-row key set and the canonical skill names so a
...
def test_list_payload_carries_every_canonical_name_in_order() -> None:
    """The frozen skill ordering is the surface contract.
