...
Public-API renames and dead-code deletions MUST be raised via `AskUserQuestion` (options: `apply` / `defer-to-backlog` / `skip`) instead of asking in free text. No persisted config bypasses this protected decision.
