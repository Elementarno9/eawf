...
gate ``import eawf.daemon.windows_pipe`` behind ``sys.platform ==
...
if sys.platform != "win32":
    raise ImportError("eawf.daemon.windows_pipe is win32-only")
...
class WindowsPipeServer:
    ...
    def _listen_loop(self) -> None:
        ...
        """
        from eawf.daemon.windows_security import (
            WindowsAuthError,
