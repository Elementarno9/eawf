...
from eawf.platform.memory.store import MemoryRecord, add_memory, append_envelope, find_envelope
...
def _next_decision_id(
    ...
    Mirrors :func:`eawf.platform.memory.store._next_memory_id`: scans the in-memory
