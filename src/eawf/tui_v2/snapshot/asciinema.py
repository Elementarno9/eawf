"""Deterministic asciinema cast generator for the ``tui_v2`` surface.
...
(:func:`~eawf.tui_v2.snapshot.pilot_harness.normalize_snapshot`) so the
...
from eawf.tui_v2.snapshot.pilot_harness import capture_screen_text, normalize_snapshot
