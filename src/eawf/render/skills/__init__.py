...
(``from eawf.render.skills import SKILL_REGISTRY, render_skill_md, ...``)
...
from eawf.render.skills.registry import SKILL_REGISTRY
from eawf.render.skills.render import (
    SkillSpec,
