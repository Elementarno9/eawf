...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "WAVE_BODY_FENCE": ("wave_body", "WAVE_BODY_FENCE"),
    "AddQuestionPayload": ("operator_input", "AddQuestionPayload"),
    "ArtifactPathStr": ("common", "ArtifactPathStr"),
    "AuditCadence": ("audit", "AuditCadence"),
    "AuditSpec": ("audit", "AuditSpec"),
    "BriefPathStr": ("common", "BriefPathStr"),
    "artifact_path_str": ("common", "artifact_path_str"),
    "CampaignDriveResult": ("campaign_driver", "CampaignDriveResult"),
    ...
    "QualityDimension": ("wave", "QualityDimension"),
    ...
    "UnfalsifiableArgv": ("falsifiability", "UnfalsifiableArgv"),
    ...
    "WaveSpecBody": ("wave_body", "WaveSpecBody"),
    "coerce_research_depth": ("research", "coerce_research_depth"),
    "drive_campaign": ("campaign_driver", "drive_campaign"),
    ...
    "unfalsifiable_argv": ("falsifiability", "unfalsifiable_argv"),
