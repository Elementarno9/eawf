...
concrete verb bodies live in :mod:`eawf.cli.commands.plugin_verbs`, and
the JSON / text envelope renderers live in
:mod:`eawf.cli.commands.plugin_render`. The verb module attaches its
...
``eawf.cli.commands.plugin.<detector>``; the conflict gates here look
...
from eawf.cli.commands import plugin_render as _plugin_render  # noqa: E402, F401
from eawf.cli.commands import plugin_verbs as _plugin_verbs  # noqa: E402, F401
