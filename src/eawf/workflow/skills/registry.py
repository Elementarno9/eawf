...
W01 froze the :class:`~eawf.workflow.skills.engine.Skill` ABC and the
:func:`~eawf.workflow.skills.engine.run_skill` orchestrator. W02/W03 will land the
...
- :func:`register` is the canonical writer. Concrete skills decorate
  themselves at import time so a single ``import eawf.workflow.skills.research``
