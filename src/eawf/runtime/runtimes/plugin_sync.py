...
2. Frozen timestamp default (:data:`~eawf.runtime.runtimes.helpers.fs.
   DEFAULT_TIMESTAMP`) so a re-run produces byte-identical output.
3. A :class:`SyncResult` aggregating each runtime's
   :class:`~eawf.runtime.runtimes.helpers.fs.FileDelta` list under the
...
from eawf.runtime.runtimes.claude.plugin_install import IntegrityViolation as ClaudeIntegrity
from eawf.runtime.runtimes.claude.plugin_install import install_plugin as install_claude_plugin
from eawf.runtime.runtimes.codex.plugin_install import IntegrityViolation as CodexIntegrity
from eawf.runtime.runtimes.codex.plugin_install import install_plugin as install_codex_plugin
from eawf.runtime.runtimes.helpers import DEFAULT_TIMESTAMP, FileDelta
    ...
    *,
    ...
    Args:
        ...
        timestamp: ISO 8601 UTC timestamp baked into managed
            ...
            :data:`~eawf.runtime.runtimes.helpers.fs.DEFAULT_TIMESTAMP`
