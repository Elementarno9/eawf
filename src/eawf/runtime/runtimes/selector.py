...
:class:`~eawf.runtime.runtimes.adapter.RuntimeAdapter` implementation. The
capability state lives in ``capabilities.yaml`` (loaded via
:func:`eawf.runtime.runtimes.capabilities.get_matrix`); adapter classes derive
...
def select_adapter(runtime_id: str) -> RuntimeAdapter:
    ...
    :mod:`eawf.runtime.runtimes.adapter`) so the adapter modules can import
    ...
    Returns:
        ...
        :class:`~eawf.runtime.runtimes.adapter.RuntimeAdapter`.
