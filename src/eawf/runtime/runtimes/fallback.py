...
from eawf.runtime.runtimes.adapter import ALL_ERROR_CLASSES, ErrorClass
...
def fallback_action(error_class: ErrorClass) -> FallbackAction:
    ...
    Args:
        error_class: A canonical error class from
            :data:`~eawf.runtime.runtimes.adapter.ErrorClass`.
...
def fall_back_to_fresh(
    *,
    ...
    :class:`~eawf.runtime.runtimes.adapter.SessionResumeFailedError` (the session
