...
The earlier per-runtime renderers (``eawf.runtime.runtimes.{claude,codex,
...
:mod:`~eawf.runtime.runtimes.helpers.sidecar` — stays under 300 lines per
...
from eawf.runtime.runtimes.helpers.fs import (
    DEFAULT_TIMESTAMP,
    FileDelta,
    classify_action,
    ensure_dir,
)
from eawf.runtime.runtimes.helpers.json_canonical import (
    body_hash_with_self,
    stable_json_bytes,
)
from eawf.runtime.runtimes.helpers.sidecar import sidecar_fingerprint
