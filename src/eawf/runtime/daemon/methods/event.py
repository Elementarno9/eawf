...
connection-handler in :mod:`eawf.runtime.daemon.server` because it produces
...
def subscribe(
    ...
    *,
    ...
    The connection handler in :mod:`eawf.runtime.daemon.server` calls this on
    ...
    Raises:
        CatchUpTooLargeError: When the catch-up window exceeds
            :data:`~eawf.runtime.daemon.bus.CATCH_UP_MAX`. The handler maps
