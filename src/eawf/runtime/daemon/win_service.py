...
Operator entrypoint: ``python -m eawf.runtime.daemon.win_service install
--startup auto`` then ``... start``. The :mod:`eawf.runtime.daemon.service_install`
...
if sys.platform != "win32":
    raise ImportError("eawf.runtime.daemon.win_service is win32-only")
...
class EawfdService(win32serviceutil.ServiceFramework):
    ...
    async def _main(self) -> None:
        ...
        :class:`eawf.runtime.daemon.windows_pipe.WindowsPipeServer` W02 ships,
