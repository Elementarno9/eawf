...
inside the :class:`~eawf.tui.scopes.ScopeScreen` shared chassis
...
* top strip — :class:`~eawf.tui.widgets.status_pane.StatusPane`
  (workspace lifecycle summary), the seam the per-repo strip rows hang
  off;
* zoom quadrant — :class:`~eawf.tui.widgets.roadmap_tree.RoadmapTree`
  beside :class:`~eawf.tui.widgets.git_pane.GitPane` +
  :class:`~eawf.tui.widgets.backlog_table.BacklogTable`, scoped to the
