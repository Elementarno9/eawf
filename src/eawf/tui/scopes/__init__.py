...
(:mod:`eawf.tui.widgets`) inside a **shared chassis** — one
:class:`~eawf.tui.widgets.header.Header` + one
:class:`~eawf.tui.widgets.footer.Footer` (which owns the
:class:`~eawf.tui.widgets.footer.Heartbeat`) reused verbatim by every
...
from eawf.tui.palette.command_palette import open_palette
from eawf.tui.screens.help import open_help
...
from eawf.tui.widgets.footer import DEFAULT_HINTS, Footer
...
class ScopeScreen(Screen[None]):
    ...
    #: :class:`~eawf.tui.app.EaApp`). Scope-specific bindings (e.g.
    ...
    def action_open_config(self) -> None:
        ...
        :func:`~eawf.tui.screens.overlays.config_modal.open_config`
    ...
    def action_force_refresh(self) -> None:
        ...
        """
        from eawf.tui.widgets.footer import Heartbeat
    ...
    def _open_detail(self, selection_id: str) -> None:
        ...
        resolves the entity to a :class:`~eawf.tui.screens.overlays.detail.DetailCard`
...
from eawf.tui.scopes.repo import RepoScreen  # noqa: E402  (after base def)
from eawf.tui.scopes.user import UserScreen  # noqa: E402
from eawf.tui.scopes.workspace import WorkspaceScreen  # noqa: E402
