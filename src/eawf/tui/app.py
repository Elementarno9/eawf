...
* :class:`EaApp` — a :class:`textual.app.App` subclass that resolves to
  ...
  reactive attribute via :class:`~eawf.tui.state_binding.StateBinding`.
...
single read-only :func:`~eawf.tui.state_binding.load_state` call
...
#: lives in :mod:`eawf.tui.widgets.header` so the shared
#: :class:`~eawf.tui.widgets.header.Header` and this module share one
...
class EaApp(App[None]):
    ...
    :class:`~eawf.tui.state_binding.StateBinding`.
    """
    ...
    async def _on_state(self, new_state: State) -> None:
        ...
        :class:`~eawf.tui.state_binding.StateBinding` refresh because
    ...
    def apply_theme(self, logical: str) -> bool:
        ...
        the pure :func:`~eawf.tui.theme.resolve_theme_name`. An
    ...
    def action_open_palette(self) -> None:
        ...
        """
        from eawf.tui.palette.command_palette import CommandPalette
