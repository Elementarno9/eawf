...
The interactive Textual app (:mod:`eawf.tui.app`) only runs at a TTY.
...
and the typed-state breadcrumb (:func:`eawf.tui.widgets.header.build_breadcrumb`)
...
from eawf.tui.widgets.footer import DEFAULT_HINTS, format_hints
