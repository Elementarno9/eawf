...
(:class:`~eawf.tui.widgets.backlog_table.BacklogTable.RowActivated`
carrying a backlog-item id,
:class:`~eawf.tui.widgets.roadmap_tree.RoadmapTree.WaveSelected`
carrying a wave id), the shared
:class:`~eawf.tui.scopes.ScopeScreen` routes the message here, and this
...
class DetailModal(ModalScreen[None]):
    ...
    def compose(self) -> ComposeResult:
        ...
        :class:`~eawf.tui.widgets.status_pane.StatusPane` uses for its
