...
route through the shared :class:`~eawf.tui.scopes.ScopeScreen` /
...
(:mod:`eawf.tui.palette.verbs`) filtered to the active scope so the
...
from eawf.tui.palette.verbs import ScopeName, visible_verbs
