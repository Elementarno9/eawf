...
The pre-W12 :func:`eawf.vcs.coauthor._runtime_from_env` did **implicit
...
used by :data:`~eawf.vcs.coauthor.CoauthorConfig.trailers`. Mirrors the
:data:`~eawf.vcs.coauthor._RUNTIME_ALIASES` constant so the two paths
stay in lock-step."""
