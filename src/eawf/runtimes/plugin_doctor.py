...
from eawf.runtimes.claude.plugin_doctor import doctor_plugin as claude_doctor_plugin
from eawf.runtimes.codex.plugin_doctor import doctor_plugin as codex_doctor_plugin
from eawf.runtimes.manifest import PluginManifest, RuntimeId
from eawf.runtimes.opencode.plugin_doctor import doctor_plugin as opencode_doctor_plugin
...
"""KISS-004 budget per :mod:`eawf.runtimes.helpers` docstring."""
...
def check_capability_vs_probe(
    *,
    ...
    Delegates to :func:`eawf.runtimes.capabilities.detect_drift` per
...
def check_helper_loc_overflow(
    ...
    *,
    ...
    Per :mod:`eawf.runtimes.helpers` docstring, the entire helpers
