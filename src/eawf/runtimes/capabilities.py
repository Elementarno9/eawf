...
def _default_matrix_path() -> Path:
    ...
    traversable = resources.files("eawf.runtimes").joinpath("capabilities.yaml")
...
def get_runtime_capabilities(runtime_id: str) -> dict[str, CapabilityCell]:
    ...
    :class:`~eawf.runtimes.claude.adapter.ClaudeAdapter` (and friends).
...
class ProbeResult:
    ...
    :class:`~eawf.runtimes.probes.sdk_baseline.RuntimeProbeRow` without
