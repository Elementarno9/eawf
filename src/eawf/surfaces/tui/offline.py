"""Re-export shim: ``offline`` moved to the shared TUI chassis.

The implementation now lives at :mod:`eawf.surfaces.tui.chassis.offline`.
...
from eawf.surfaces.tui.chassis import offline as _offline

sys.modules[__name__] = _offline
