...
class DoctorModeScreen(ScopeScreen):
    ...
    async def _gather_health(self) -> None:
        ...
        While the gather is in flight the App's
        ...
        if hasattr(self.app, "_health_probe_in_flight"):
            self.app._health_probe_in_flight = True
        try:
            ...
            if hasattr(self.app, "_health_probe_in_flight"):
                self.app._health_probe_in_flight = False
