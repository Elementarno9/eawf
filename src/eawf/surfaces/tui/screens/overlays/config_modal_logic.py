...
:mod:`eawf.surfaces.tui.screens.overlays.config_modal`: the ``Enter``-action
...
def save_dirty_fields(
    ...
    *,
    ...
    Routes each key through :func:`eawf.surfaces.cli.commands.config._save_value_to_layer`
    ...
    Args:
        ...
        save_fn: Test seam — defaults to
            :func:`eawf.surfaces.cli.commands.config._save_value_to_layer`. The
    ...
    if save_fn is None:
        from eawf.surfaces.cli.commands.config import _save_value_to_layer as _default_save_fn
