...
The Typer root callback in :mod:`eawf.surfaces.cli.app` parses the global flags
...
parameters indirectly through :mod:`eawf.surfaces.cli._mutation`, which derives
