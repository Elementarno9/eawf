...
(:mod:`eawf.surfaces.cli.app`) stays — this verb is the only completion entry point so
...
def _zsh_native_script() -> str:
    ...
    from eawf.surfaces.cli.app import app  # lazy import: avoid app -> completion cycle
