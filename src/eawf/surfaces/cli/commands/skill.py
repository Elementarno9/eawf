...
def render_cmd(
    ...
    :func:`~eawf.surfaces.render.skills.render_skill_md_from_spec` helper.
    ...
    Unknown skill name → :class:`~eawf.surfaces.cli.errors.UserError`
    (``kind="InvalidInput"``, exit code 3, mirrors
    :func:`_resolve_skill_name`).
    Unknown ``--format`` → :class:`~eawf.surfaces.cli.errors.UserError`
