...
(:class:`eawf.state.models.Phase`) tracks reality (status, claim/close
...
from eawf.spec.common import FileScopeRef, VerdictCitation, _StrictModel
from eawf.state.models import IterIdStr, PhaseIdStr
