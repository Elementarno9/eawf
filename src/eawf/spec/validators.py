...
1. **Model-time** — Pydantic ``model_validator`` hooks live on the
   models themselves (e.g. :class:`~eawf.spec.wave.WaveSpec._consistent_ids`
   and :class:`~eawf.spec.wave.WaveSpec._mockup_required`). They run at
...
from eawf.spec.heuristics import missing_test_paths
from eawf.spec.phase import PhaseSpec
