...
matching a :class:`~eawf.config.registry.config_keys.ConfigKey` entry's
...
from eawf.config.registry.config_keys import CONFIG_REGISTRY, ConfigKey, registry_lookup
