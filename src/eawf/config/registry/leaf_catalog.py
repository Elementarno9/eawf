...
:class:`~eawf.config.registry.leaf_keys.LeafKey` record naming its declared
...
the sibling :mod:`eawf.config.registry.leaf_keys` module; this module owns
...
from eawf.config.registry.leaf_keys import (
